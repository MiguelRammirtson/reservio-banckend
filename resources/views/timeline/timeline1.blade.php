                                 ...
                                 <div class="d-inline-block w-100">
                                    ...
                                    <div class="iq-media-group">
                                       <a href="#" class="iq-media">
                                          <img class="img-fluid avatar-40 rounded-circle" src={{URL::asset("images/user/05.jpg")}} " alt="">
                                       </a>
                                       <a href="#" class="iq-media">
                                          <img class="img-fluid avatar-40 rounded-circle" src={{URL::asset("images/user/06.jpg")}}  alt="">
                                       </a>
                                       <a href="#" class="iq-media">
                                          <img class="img-fluid avatar-40 rounded-circle" src={{URL::asset("images/user/07.jpg")}}  alt="">
                                       </a>
                                       <a href="#" class="iq-media">
                                          <img class="img-fluid avatar-40 rounded-circle" src={{URL::asset("images/user/08.jpg")}}  alt="">
                                       </a>
                                       <a href="#" class="iq-media">
                                          <img class="img-fluid avatar-40 rounded-circle" src={{URL::asset("images/user/09.jpg")}}  alt="">
                                       </a>
                                       <a href="#" class="iq-media">
                                          <img class="img-fluid avatar-40 rounded-circle" src={{URL::asset("images/user/10.jpg")}}  alt="">
                                       </a>
                                    </div>
                                 </div>
                              </li>
