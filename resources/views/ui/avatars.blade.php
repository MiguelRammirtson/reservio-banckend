...
&#x3C;/div&#x3E;
                     ...
                     <div class="iq-avatars d-flex flex-wrap align-items-center">
                        ...
                        <div class="iq-avatar">
                           <div class="iq-media-group">
                              <a href="#" class="iq-media">
                                 <img class="img-fluid avatar-50 rounded" src={{ asset("/images/user/05.jpg")}} alt="">
                              </a>
                              <a href="#" class="iq-media">
                                 <img class="img-fluid avatar-50 rounded" src={{ asset("/images/user/06.jpg")}} alt="">
                              </a>
                              <a href="#" class="iq-media">
                                 <img class="img-fluid avatar-50 rounded" src={{ asset("/images/user/07.jpg")}} alt="">
                              </a>
                           </div>
                        </div>
                        <div class="iq-avatar">
                           <div class="iq-media-group">
                              <a href="#" class="iq-media">
                                 <img class="img-fluid avatar-40 rounded" src={{ asset("/images/user/05.jpg")}} alt="">
                              </a>
                              <a href="#" class="iq-media">
                                 <img class="img-fluid avatar-40 rounded" src={{ asset("/images/user/06.jpg")}} alt="">
                              </a>
                              <a href="#" class="iq-media">
                                 <img class="img-fluid avatar-40 rounded" src={{ asset("/images/user/07.jpg")}} alt="">
                              </a>
                           </div>
                        </div>
                     </div>
