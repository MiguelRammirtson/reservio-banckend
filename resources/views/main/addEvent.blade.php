        ...
        <div class="row">
            <div class="col-lg-12 mb-4">
                <div class="py-4 border-bottom">
                    <div class="float-left"><a href="{{route('page-new-event')}}" class="badge bg-white back-arrow"><i class="las la-angle-left"></i></a></div>
                    ...
                    <div class="card-body p-5">
                        <div class="row">
                                ...
                                <div class="search-dropdown-select device-search">   
                                    <div class="input-prepend input-append">
                                        <div class="btn-group w-100">
                                            ...
                                            <input class="dropdown-toggle search-query text search-input" type="text"  placeholder="Add a Location"><span class="search-replace"></span>
                            ...
                            <div class="col-lg-12 mb-4">
                                ...
                                <input type="text" class="form-control" value="calendly.com/rickoshea1234/">
                            </div>
                            <div class="col-lg-12 mt-4">
                                <div class="d-flex flex-wrap align-items-ceter justify-content-center">
                                    <div class="btn btn-primary mr-4"><a href="index.html" class="cancel-btn">Cancel</a></div>
                                    <div class="btn btn-outline-primary"><a href="#" class="save-btn">Next</a></div>
                                </div>
                            </div> 
                        </div>
                    </div>
