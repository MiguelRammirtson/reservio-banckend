...
if (jQuery("#apex-radialbar-chart").length) {
  options = {
    ...
    colors: ["#465af7", "#ea643f", "#7858d7", "#5baa73"]
  };
...
if (jQuery("#apex-pie-chart").length) {
  options = {
    ...
    colors: ["#465af7", "#ea643f", "#7858d7", "#5baa73", "#c8c8c8"],
    responsive: [{
      breakpoint: 480,
      options: {
        chart: {
...
-----------------------------------------------------------------------*/
    ...
    if(jQuery('#am-simple-chart').length){
      ...
      chart.colors.list = [am4core.color("#465af7"),];
   ...
   if(jQuery('#am-columnlinr-chart').length){
      ...
      lineSeries.stroke = am4core.color("#465af7");
   ...
   if(jQuery('#am-stackedcolumn-chart').length){
      ...
      chart.colors.list = [am4core.color("#ea643f"),
      am4core.color("#5baa73"),
      am4core.color("#f4a965")];
   ...
   if(jQuery('#am-polarscatter-chart').length){
      ...
      var chart = am4core.create("am-polarscatter-chart", am4charts.RadarChart);
       chart.colors.list = [am4core.color("#465af7"),am4core.color("#f4a965"),am4core.color("#5baa73")];
   ...
   if(jQuery('#am-3dpie-chart').length){
      ...
      series.colors.list = [am4core.color("#465af7"),am4core.color("#5baa73"),am4core.color("#ea643f"),
      am4core.color("#f4a965"),am4core.color("#7858d7"),am4core.color("#01041b")];
   ...
   if(jQuery('#am-layeredcolumn-chart').length){
      ...
      chart.colors.list = [am4core.color("#5baa73"),am4core.color("#465af7")];
...
ykeys: ['y', 'z', 'a'],
labels: ['Y', 'Z', 'A'],
barColors: ['#465af7', '#f4a965', '#5baa73'],
